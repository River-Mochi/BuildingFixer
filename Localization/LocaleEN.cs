    ...
    public sealed class LocaleEN : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            var d = new Dictionary<string, string>
            {
                ...
                // Abandoned
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.RemoveAbandoned)), "Remove Abandoned" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.RemoveAbandoned)),  "Automatically demolishes Abandoned buildings and their child entities." },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.DisableAbandonment)), "Disable Abandonment" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.DisableAbandonment)),  "Keeps buildings alive by clearing Abandoned/Collapsed and restoring services over time." },
                ...
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.RemoveCondemned)), "Remove Condemned" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.RemoveCondemned)),  "Automatically demolishes buildings that become Condemned." },
